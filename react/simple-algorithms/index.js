...
//1. define sum variable as 0
let sum = 0;
numbers.forEach(sumNumbers);

function sumNumbers(number) {
  // TODO: we need to calculate each number in the array with each other +
  //2. we need a loop that take 1 number of the array, to add it to the other
  //3. Identify which loop to use / forEach, while, for of, reduce
  //
  sum += number;
}
sumNumbers(number);
