...
let operand1 = 12; //had to be changed from const to let, because it's changing.
const operand2 = 4;
...
const increaseButton = document.querySelector('[data-js="increase-by-one"]');
...
const decreaseButton = document.querySelector('[data-js="decrease-by-one"]');
