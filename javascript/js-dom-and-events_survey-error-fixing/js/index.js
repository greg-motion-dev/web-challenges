...
//Answer: it's better to target the data-js="next-button" than the ID.
...
//Answer: the "prev" as changed to click, now it works, since the event "prev" means nothing.
...
//Answer: console.log was not written correctly.
...
//Answer: firstChoiceButton and secondChoiceButton both had remove(), firstChoice needed to be changed to add().
