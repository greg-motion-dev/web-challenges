...
const nameOfFirstPerson = people[0].name;  // Should be Homer
...
const ageOfThirdPerson = people[2].age; //age of bart

// EXERCISE 4
// Set the variable `mothersNameOfSecondPerson` to the mother's name of the second person.

const mothersNameOfSecondPerson = people[1].parents.mothersName; // Marge's mother
